  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-6 py-32 text-center">
        ...
        <p className="text-gray-400 text-xl mb-10">Cette page n'existe pas ou a été déplacée.</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/outils" className="gradient-card border border-purple-500/30 text-white px-8 py-4 rounded-xl font-semibold hover:border-purple-500/60 hover:-translate-y-0.5 transition-all">Voir les outils</Link>
        </div>
      </main>
      <Footer />
    </div>
