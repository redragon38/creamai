        ...
        <section className="relative py-24 text-center overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-5 leading-tight">
              ...
              <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">vous pouvez avoir confiance</span>
            </h1>
        ...
        <div className="container mx-auto px-6 pb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {STEPS.map((step, i) => (
                <div key={i} className="gradient-card rounded-2xl p-6 relative overflow-hidden group hover:-translate-y-2 hover:border-purple-500/50 transition-all">
                  <div className="absolute -top-3 -right-3 text-6xl font-black text-purple-900/30">{step.num}</div>
                ...
                {[
                  ...
                  <div key={i} className="mb-4">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="text-purple-300 font-bold">{item.val}/100</span>
                    </div>
          ...
          <section className="relative gradient-card rounded-3xl p-12 text-center border-purple-500/30 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 mb-8 max-w-md mx-auto">Plus de 32 outils vérifiés, organisés par catégorie pour faciliter votre choix.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/comparatifs" className="gradient-card border border-purple-500/30 text-white px-10 py-4 rounded-xl font-semibold hover:border-purple-500/60 hover:-translate-y-0.5 transition-all">
