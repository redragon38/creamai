...
const ARTICLES = {
  'meilleur-vpn-2025': {
    category: 'VPN', catColor: 'text-blue-300 bg-blue-900/20 border-blue-500/20',
  ...
  'hebergement-wordpress-2025': {
    category: 'Hébergement', catColor: 'text-emerald-300 bg-emerald-900/20 border-emerald-500/20',
  ...
  'antivirus-gratuit-vs-payant': {
    category: 'Antivirus', catColor: 'text-red-300 bg-red-900/20 border-red-500/20',
  ...
  'outils-ia-productivite': {
    category: 'IA', catColor: 'text-purple-300 bg-purple-900/20 border-purple-500/20',
      ...
      <main>
        <section className="relative py-16 overflow-hidden">
          ...
          <div className="container mx-auto px-6 max-w-3xl relative z-10">
            <Link href="/blog" className="inline-flex items-center gap-2 text-purple-400 hover:text-purple-300 mb-8 transition-colors text-sm">
              <ArrowLeft className="w-4 h-4" /> Retour au blog
            </Link>
            <div className="flex items-center gap-3 mb-6">
              <span className={`text-xs font-bold px-3 py-1 rounded-full border ${article.catColor}`}>{article.category}</span>
              <span className="text-gray-500 text-sm">{article.date} · {article.readTime} de lecture</span>
            </div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed border-l-4 border-purple-500 pl-5">{article.intro}</p>
          </div>
        </section>
