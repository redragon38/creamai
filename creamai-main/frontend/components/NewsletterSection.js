      ...
      <div className="container mx-auto px-6">
        <div className="relative bg-gradient-to-br from-purple-900/30 to-pink-900/10 border border-purple-500/30 rounded-3xl p-12 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 mb-8 max-w-md mx-auto">Chaque semaine, recevez la sélection des meilleurs outils, offres exclusives et guides pratiques — directement dans votre boîte mail.</p>
            {!submitted ? (
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 bg-[#0a0118]/80 border border-purple-500/30 rounded-xl px-5 py-3.5 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 transition-all"
                />
              ...
              <div className="text-green-400 font-bold text-lg py-3">🎉 Merci ! Vous êtes bien inscrit(e) !</div>
            )}
