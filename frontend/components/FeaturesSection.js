      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 gradient-card rounded-2xl p-8">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">{features[0].description}</p>
              </div>
            </div>
            {/* Chart Visualization */}
          ...
          <div className="gradient-card rounded-2xl p-6">
            ...
            <p className="text-gray-400 text-sm mb-4">{features[1].description}</p>
          ...
          <div className="gradient-card rounded-2xl p-6">
            ...
            <p className="text-gray-400 text-sm">{features[2].description}</p>
          </div>
          ...
          <div className="gradient-card rounded-2xl p-6">
            ...
            <p className="text-gray-400 text-sm mb-4">{features[3].description}</p>
          ...
          <div className="gradient-card rounded-2xl p-6">
            ...
            <p className="text-gray-400 text-sm mb-4">{features[4].description}</p>
