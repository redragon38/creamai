...
const PERKS = [
  { icon: <Zap className="w-5 h-5 text-gray-900" />, title: 'Nouveaux outils en avant-première', desc: 'Soyez le premier informé des meilleures sorties avant tout le monde.' },
  { icon: <Gift className="w-5 h-5 text-gray-900" />, title: 'Offres exclusives & réductions', desc: 'Des codes promo négociés uniquement pour nos abonnés.' },
  { icon: <Star className="w-5 h-5 text-gray-900" />, title: 'Sélection hebdomadaire experte', desc: 'Un condensé des meilleurs outils de la semaine, triés sur le volet.' },
  { icon: <Shield className="w-5 h-5 text-gray-900" />, title: 'Zéro spam, désinscription facile', desc: '1 email par semaine max. Vous pouvez partir en 1 clic à tout moment.' },
];
      ...
      <main>
        ...
        <section className="relative py-24 text-center overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="inline-flex items-center gap-2 bg-purple-900/30 border border-purple-500/30 text-gray-600 px-4 py-2 rounded-full text-sm font-semibold mb-6">
              <Mail className="w-4 h-4" /> Newsletter gratuite
            </div>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              Restez à la pointe<br />
              <span className="text-gray-900">chaque semaine</span>
            </h1>
            <p className="text-gray-900 text-xl max-w-lg mx-auto mb-10">
              Rejoignez <strong className="text-gray-900">{count.toLocaleString()}+ créateurs</strong> qui reçoivent chaque semaine les meilleurs outils, offres et guides.
            </p>
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto mb-4">
                <input
                  ...
                  className="flex-1 bg-white border border-purple-500/30 rounded-xl px-5 py-4 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-purple-500 transition-all"
                />
              ...
              <div className="flex items-center justify-center gap-3 text-gray-900 font-bold text-xl mb-4 py-4">
            ...
            {error && <p className="text-red-500 text-sm mt-2">Une erreur s'est produite. Réessayez ou écrivez à <a href="mailto:l.bonin2011@gmail.com" className="underline">l.bonin2011@gmail.com</a></p>}
          </div>
        </section>
        ...
        <div className="container mx-auto px-6 pb-24">
              ...
              {PREVIOUS.map((issue, i) => (
                <div key={i} className="gradient-card rounded-2xl p-5 flex items-center gap-5 hover:border-purple-500/50 hover:-translate-y-1 transition-all cursor-pointer group">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="font-bold text-sm group-hover:text-gray-900 transition-colors truncate">{issue.subject}</p>
                    <p className="text-gray-600 text-xs mt-1 truncate">{issue.preview}</p>
                  </div>
                  <Mail className="w-5 h-5 text-gray-900 group-hover:text-gray-900 transition-colors flex-shrink-0" />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-purple-900/30 to-pink-900/10 border border-purple-500/30 rounded-3xl p-14 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-900 mb-8 max-w-md mx-auto">{count.toLocaleString()}+ entrepreneurs et créateurs nous font déjà confiance.</p>
              {!submitted ? (
                ...
                <p className="text-gray-900 font-bold text-lg">🎉 Vous êtes inscrit(e) !</p>
              )}
            </div>
          </div>
        </div>
