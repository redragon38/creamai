...
const META = {
  label: 'Antivirus', catFilter: 'Antivirus', icon: '🦠',
  color: 'from-red-600 to-orange-500', colorLight: 'from-red-50 to-orange-50',
  border: 'border-red-200', badge: 'bg-blue-100 border-red-200 text-gray-900',
  desc: 'Les meilleurs antivirus pour protéger vos appareils contre les menaces en 2025.',
};
