        ...
        <section className="relative py-24 text-center overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-5 leading-tight">
              Ils nous font<br />
              <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">confiance</span>
            </h1>
        ...
        <div className="container mx-auto px-6 pb-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            {STATS.map((s, i) => (
              <div key={i} className="gradient-card rounded-2xl p-6 text-center">
                <div className="text-3xl font-extrabold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-1">{s.number}</div>
              ...
              <div key={i} className="break-inside-avoid gradient-card rounded-2xl p-6 hover:-translate-y-1 hover:border-purple-500/50 transition-all inline-block w-full">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${t.color} flex items-center justify-center font-bold text-white flex-shrink-0`}>
                      {t.initial}
                    </div>
                    <div>
                  ...
                  <span className="text-xs bg-purple-900/30 border border-purple-500/20 text-purple-300 px-2 py-0.5 rounded-full">{t.category}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="relative gradient-card rounded-3xl p-12 text-center border-purple-500/30 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 mb-8 max-w-md mx-auto">Rejoignez des milliers d'utilisateurs satisfaits et découvrez les meilleures solutions pour votre activité.</p>
