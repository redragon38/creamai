...
const META = {
  label: 'Intelligence Artificielle', catFilter: 'Intelligence artificielle', icon: '🤖',
  color: 'from-violet-600 to-purple-500', colorLight: 'from-violet-50 to-purple-50',
  border: 'border-violet-200', badge: 'bg-blue-100 border-violet-200 text-gray-900',
