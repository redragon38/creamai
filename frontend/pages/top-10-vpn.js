...
const META = {
  label: 'VPN', catFilter: 'VPN', icon: '🛡️',
  color: 'from-blue-600 to-cyan-500', colorLight: 'from-blue-50 to-cyan-50',
  border: 'border-blue-200', badge: 'bg-blue-100 border-blue-200 text-gray-900',
  desc: 'Les meilleurs VPN pour sécuriser votre connexion et protéger votre vie privée en 2025.',
};
